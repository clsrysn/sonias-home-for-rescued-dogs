      ...
      <Layout>
        ...
        <section className="bg-background py-12">
          <div className="container grid gap-10 md:grid-cols-2">
            {/* Main Photo */}
            <div 
              className="rounded-lg overflow-hidden border border-border shadow-md cursor-pointer hover:shadow-lg transition-shadow"
              onClick={() => handleImageClick(dogPhotos[0] || dog.image)}
            >
              <img 
                src={dog.image || dogPhotos[0]} 
                alt={dog.name} 
          ...
          <section className="bg-muted py-12">
            <div className="container">
              ...
              <div className="relative max-w-2xl mx-auto">
                <div 
                  className="aspect-video rounded-lg overflow-hidden border border-border shadow-md cursor-pointer"
                  onClick={() => handleImageClick(dogPhotos[currentPhoto])}
                >
                  <img
